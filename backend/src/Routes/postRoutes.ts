...
import { createComment, createPost, deleteComment, deletePost, getAllComments, getAllPosts, getPostComments, getPostLikes, getSinglePost, toggleLikePost, updateComment, updatePost } from "../controllers/postController";
